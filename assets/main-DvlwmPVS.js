import{a as j,i as h,g as O,r as D}from"./vendor-DvC1QdLM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const w=j.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});class L{static async getExercises(t={}){const{page:s=1,limit:i=10}=t;return(await w.get("/exercises",{params:{page:s,limit:i,...t}})).data}static async addRateByExerciseId(t,s){return(await w.patch(`/exercises/${t}/rating`,s)).data}static async getExerciseById(t){return(await w.get(`/exercises/${t}`)).data}static async getFilters(t={}){const{page:s=1,limit:i=12}=t;return(await w.get("/filters",{params:{page:s,limit:i,...t}})).data}static async getQuote(){return(await w.get("/quote")).data}static async addSubscription(t){return(await w.post("/subscription",t)).data}}(()=>{if(!document.querySelector("footer"))return;const t=document.querySelector(".js-footer-form"),s=document.querySelector('input[type="email"]'),i=document.querySelector(".footer_form_btn");i.addEventListener("click",n);function a(c){return/^\w+(.\w+)?@[a-zA-Z_]+?.[a-zA-Z]{2,3}$/.test(c)}i.disabled=!0,s.addEventListener("input",()=>{const c=s.value;a(c)?(i.classList.add("active"),i.disabled=!1,s.classList.add("active")):(i.classList.remove("active"),i.disabled=!0,s.classList.remove("active"))}),s.addEventListener("blur",()=>{const c=s.value;c!==""&&(a(c)?i.classList.add("active"):h.error({title:"Error",message:"Invalid email address was entered."}))});function n(c){c.preventDefault();const l=s.value;if(!a(l)){h.error({title:"Error",message:"Invalid email address was entered."});return}const u={email:l};L.addSubscription(u).then(d=>{const y=d.message;h.success({title:"Success",message:y}),i.disabled=!0,s.classList.remove("active"),i.classList.remove("active")}).catch(d=>{const y=d.response.message;d.response.status===409?h.warning({title:"Warning",message:"Subscription already exists"}):d.response.status===400&&h.warning({title:"Warning",message:y})}),t.reset()}const o={root:null,rootMargin:"0px",threshold:0},m=document.querySelector(".footer_logo_icon"),v=document.querySelector(".footer_title_span");new IntersectionObserver(g,o).observe(m);function g(c,l){c.forEach(u=>{u.isIntersecting&&(O.to(m,{duration:2,opacity:1,x:0,rotationX:360}),O.to(v,{duration:2,opacity:1}))})}})();(()=>{const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),s=document.querySelector(".js-close-menu"),i=document.querySelectorAll(".menu-link"),a=document.querySelector(".mobile-menu-overlay"),n=()=>{const o=t.getAttribute("aria-expanded")==="true"||!1;t.setAttribute("aria-expanded",!o),e.classList.toggle("is-open")};t.addEventListener("click",n),s.addEventListener("click",n),i.forEach(o=>{o.addEventListener("click",n)}),a.addEventListener("click",n),window.matchMedia("(min-width: 768px)").addEventListener("change",o=>{o.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1))})})();const k="exercises",H="storageUpdateCustomEvent",P=(e,t)=>e.closest(t),ee=(e,t=!1)=>{if(t){const s=e.querySelector(".loader");s&&s.remove()}else e.insertAdjacentHTML("beforeend",'<div class="loader"></div>')},te=e=>{if(Array.isArray(e))for(let t of e)t.innerHTML="";else e.innerHTML=""},f="/project-5/assets/icons-r3pL_5Hc.svg",K=e=>e%1?`${Math.round(e*10)/10}`:`${e}.0`,se=(e,t)=>{const s=e.map(i=>`<li class="item"><a class="filter-link" href="#">${i}</a></li>`).join("");t.insertAdjacentHTML("beforeend",s)},ae=(e,t)=>{const s=e.map(({filter:i,name:a,imgURL:n})=>`
      ...
      `).join("");t.insertAdjacentHTML("beforeend",s)},ie=(e,t,s=!1)=>{const i=e.map(({bodyPart:a,burnedCalories:n,gifUrl:o,name:m,rating:v,target:p,time:g,_id:c})=>{const l=s?`<a class="trash-link" href="#" title="Remove">
              <svg class="icon-trash" width="16" height="16">
                <use href="${f}#icon-trash"></use>
              </svg>
            </a>`:`<div class="exercises-ratio"><p class="ratio-value">${K(v)}</p><svg class="icon-star ratio-star" width="20" height="20"><use href="${f}#icon-star"></use></svg></div>`;return`
      <li class="card-item" data-id="${c}">
        <div class="card-header">
          ...
          <button class="modal-exercise-info" type="button" data-id="${c}">
                        <span>Start</span>
                        <svg class="icon-arrow-right icon-arrow" width="12" height="12"><use href="${f}#icon-arrow-right"></use></svg>
          </button>
        </div>
        <div class="card-content">
          <img
    ...
    </li>`;let a="";for(let n=0;n<5;n++)n<t?a+=i("full"):n==t&&s>0?a+=i("partial",`<svg class="overlay" style="clip-path:inset(0 ${100-s}% 0 0);"><use href="${f}#icon-star"></use></svg>`):a+=i("empty");return a},$=(e,t)=>{const s=`
      ${e?"Remove from favorites":"Add to favorites"}
        <svg class="favorite-icon" width="18" height="18">
          <use href="${f}#${e?"icon-trash":"icon-heart"}"></use>
        </svg>`;t.innerHTML=s,e?t.classList.add("remove"):t.classList.remove("remove")},N=(e,t,s)=>{const{bodyPart:i,burnedCalories:a,description:n,equipment:o,gifUrl:m,name:v,popularity:p,rating:g,target:c,time:l,_id:u}=e,d=`
      ...
      <div class="modal-content">
        ...
        <ul class="details">
          ...
          <li class="details-item">
            ...
            <p class="details-value">${a}/${l} min</p>
          </li>
        </ul>
