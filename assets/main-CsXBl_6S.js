import{a as K,i as f,g as C,r as F}from"./vendor-DvC1QdLM.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const L=K.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});class S{static async getExercises(e={}){const{page:s=1,limit:a=10}=e;return(await L.get("/exercises",{params:{page:s,limit:a,...e}})).data}static async addRateByExerciseId(e,s){return(await L.patch(`/exercises/${e}/rating`,s)).data}static async getExerciseById(e){return(await L.get(`/exercises/${e}`)).data}static async getFilters(e={}){const{page:s=1,limit:a=12}=e;return(await L.get("/filters",{params:{page:s,limit:a,...e}})).data}static async getQuote(){return(await L.get("/quote")).data}static async addSubscription(e){return(await L.post("/subscription",e)).data}}const I=(t,e)=>t.closest(e),ae=(t,e=!1)=>{if(e){const s=t.querySelector(".loader");s&&s.remove()}else t.insertAdjacentHTML("beforeend",'<div class="loader"></div>')},ie=t=>{if(Array.isArray(t))for(let e of t)e.innerHTML="";else t.innerHTML=""};function b(t){return/^\w+(.\w+)?@[a-zA-Z_]+?.[a-zA-Z]{2,3}$/.test(t)}const v="/project-5/assets/icons-C2d4C28r.svg",U=t=>t%1?`${Math.round(t*10)/10}`:`${t}.0`,ne=(t,e)=>{const s=t.map(a=>`<li class="item"><a class="filter-link" href="#">${a}</a></li>`).join("");e.insertAdjacentHTML("beforeend",s)},oe=(t,e)=>{const s=t.map(({filter:a,name:i,imgURL:n})=>`
