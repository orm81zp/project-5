import{a as K,i as h,g as C,r as F}from"./vendor-DvC1QdLM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const k=K.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});class S{static async getExercises(t={}){const{page:s=1,limit:a=10}=t;return(await k.get("/exercises",{params:{page:s,limit:a,...t}})).data}static async addRateByExerciseId(t,s){return(await k.patch(`/exercises/${t}/rating`,s)).data}static async getExerciseById(t){return(await k.get(`/exercises/${t}`)).data}static async getFilters(t={}){const{page:s=1,limit:a=12}=t;return(await k.get("/filters",{params:{page:s,limit:a,...t}})).data}static async getQuote(){return(await k.get("/quote")).data}static async addSubscription(t){return(await k.post("/subscription",t)).data}}const I=(e,t)=>e.closest(t),ae=(e,t=!1)=>{if(t){const s=e.querySelector(".loader");s&&s.remove()}else e.insertAdjacentHTML("beforeend",'<div class="loader"></div>')},ie=e=>{if(Array.isArray(e))for(let t of e)t.innerHTML="";else e.innerHTML=""};function L(e){return/^\w+(.\w+)?@[a-zA-Z_]+?.[a-zA-Z]{2,3}$/.test(e)}const f="/project-5/assets/icons-C2d4C28r.svg",U=e=>e%1?`${Math.round(e*10)/10}`:`${e}.0`,ne=(e,t)=>{const s=e.map(a=>`<li class="item"><a class="filter-link" href="#">${a}</a></li>`).join("");t.insertAdjacentHTML("beforeend",s)},oe=(e,t)=>{const s=e.map(({filter:a,name:i,imgURL:n})=>`
      ...
      `).join("");t.insertAdjacentHTML("beforeend",s)},re=(e,t,s=!1)=>{const a=e.map(({bodyPart:i,burnedCalories:n,gifUrl:o,name:p,rating:y,target:g,time:c,_id:u})=>{const l=s?`<a class="trash-link" href="#" title="Remove">
    ...
    <li class="rating-item">
    ...
    </li>`;let i="";for(let n=0;n<5;n++)n<t?i+=a("full"):n==t&&s>0?i+=a("partial",`<svg class="overlay" style="clip-path:inset(0 ${100-s}% 0 0);"><use href="${f}#icon-star"></use></svg>`):i+=a("empty");return i},x=(e,t)=>{const s=`
      ${e?"Remove from favorites":"Add to favorites"}
        <svg class="favorite-icon" width="18" height="18">
          <use href="${f}#${e?"icon-trash":"icon-heart"}"></use>
        </svg>`;t.innerHTML=s,e?t.classList.add("remove"):t.classList.remove("remove")},N=(e,t,s)=>{const{bodyPart:a,burnedCalories:i,description:n,equipment:o,gifUrl:p,name:y,popularity:g,rating:c,target:u,time:l,_id:d}=e,m=`
      ...
      </div>`;s.innerHTML=m};function V(e){return e.map(t=>{const{name:s,linkedin:a,github:i}=t;return` <li class="team-item">
