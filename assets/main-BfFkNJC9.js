import{a as I,r as A,i as c,g as u}from"./vendor-CpjBsdJ0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const d=I.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});class h{static async getExercises(e={}){const{page:a=1,limit:n=10}=e;return(await d.get("/exercises",{params:{page:a,limit:n,...e}})).data}static async addRateByExerciseId(e,a){return(await d.patch(`/exercises/${e}/rating`,a)).data}static async getExerciseById(e){return(await d.get(`/exercises/${e}`)).data}static async getFilters(e={}){const{page:a=1,limit:n=12}=e;return(await d.get("/filters",{params:{page:a,limit:n,...e}})).data}static async getQuote(){return(await d.get("/quote")).data}static async addSubscription(e){return(await d.post("/subscription",e)).data}}async function R(){try{const t=new Date().toLocaleDateString(),e=JSON.parse(localStorage.getItem("quoteData"));if(e&&e.date===t)return e.quote;let a=await h.getQuote();const n={date:t,quote:a};return localStorage.setItem("quoteData",JSON.stringify(n)),n.quote}catch{console.log("Error during  getting quote")}}R().then(t=>{document.getElementById("quote_text").innerText=t.quote,document.getElementById("quote_author").innerText=t.author});(()=>{const t=document.querySelector(".js-menu-container"),e=document.querySelector(".js-open-menu"),a=document.querySelector(".js-close-menu"),n=document.querySelectorAll(".menu-link"),s=document.querySelector(".mobile-menu-overlay"),o=()=>{const r=e.getAttribute("aria-expanded")==="true"||!1;e.setAttribute("aria-expanded",!r),t.classList.toggle("is-open")};e.addEventListener("click",o),a.addEventListener("click",o),n.forEach(r=>{r.addEventListener("click",o)}),s.addEventListener("click",o),window.matchMedia("(min-width: 768px)").addEventListener("change",r=>{r.matches&&(t.classList.remove("is-open"),e.setAttribute("aria-expanded",!1))})})();const K=(t,e)=>{const a=t.map(n=>`<li class="item"><a href="#">${n}</a></li>`).join("");e.insertAdjacentHTML("beforeend",a)},G=(t,e)=>{const a=t.map(({filter:n,name:s,imgURL:o})=>`
      ...
      `}).join("");e.insertAdjacentHTML("beforeend",n)},j=(t,e)=>{const{bodyPart:a,burnedCalories:n,description:s,equipment:o,gifUrl:r,name:f,popularity:b,rating:m,target:p,time:v,_id:S}=t,B=`
      ...
      `;e.innerHTML=B};let i={},y={},$;const O=async t=>{try{const e=await h.getExerciseById(t);j(e,i.container),i.modal.classList.toggle("is-hidden"),F(e._id)}catch(e){console.log(e)}},k=()=>{i={opener:document.querySelector("[data-modal-open]"),closer:document.querySelector("[data-modal-close]"),modal:document.querySelector("[data-modal]"),container:document.querySelector("[data-modal-content]")},!(!i.opener||!i.closer||!i.modal||!i.container)&&(i.opener.addEventListener("click",t=>{const e=t.target;if(e.nodeName!=="A")return;const a=e.dataset.id;a&&O(a)}),i.closer.addEventListener("click",()=>{i.modal.classList.toggle("is-hidden"),i.container.innerHTML=""}))};function w(t){let e=document.querySelector(".raiting-value");e.innerText=`${t.toFixed(1)}`}let M=A({starSize:24,element:document.querySelector("#rater"),rateCallback:function(e,a){w(e),this.setRating(e),a()}});function z(){document.querySelector(".raiting-form input").value="",document.querySelector(".raiting-form textarea").value="",M.clear()}function D(t){try{h.addRateByExerciseId($,{rate:M.getRating(),email:t.target[0].value,review:t.target[1].value})}catch(e){c.error({title:"Error",message:"Unable to send rate"}),console.log(e)}finally{w(0),z(),E()}}const P=document.querySelector(".raiting-form");P.addEventListener("submit",t=>{t.preventDefault();const e=!t.target[0].value,a=!t.target[1].value;if(e||a){c.error({title:"Error",message:"Email and comment fields should not be empty"});return}D(t)});function E(){y.modal.classList.toggle("is-hidden"),i.modal.classList.toggle("is-hidden")}const F=t=>{$=t,y={openModalBtn:document.querySelector("[data-raiting-modal-open]"),closeModalBtn:document.querySelector("[data-raiting-modal-close]"),modal:document.querySelector("[data-raiting-modal]")},y.openModalBtn.addEventListener("click",E),y.closeModalBtn.addEventListener("click",E)};window.addEventListener("load",()=>{k()});const N=document.querySelector(".js-footer-form"),g=document.querySelector('input[type="email"]'),l=document.querySelector(".footer_form_btn");l.addEventListener("click",H);function x(t){return/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/.test(t)}l.disabled=!0;g.addEventListener("input",()=>{const t=g.value;x(t)?(l.classList.add("active"),l.disabled=!1):(l.classList.remove("active"),l.disabled=!0)});g.addEventListener("blur",()=>{const t=g.value;x(t)?l.classList.add("active"):c.error({title:"Error",message:"Invalid email address was entered."})});function H(t){t.preventDefault();const e=g.value;if(!x(e)){console.log("tyta"),c.error({title:"Error",message:"Invalid email address was entered."});return}const a={email:e};h.addSubscription(a).then(n=>{const s=n.data.message;c.success({title:"Success",message:s})}).catch(n=>{const s=n.response.data.message;n.response.status===409?c.warning({title:"Warning",message:"Subscription already exists"}):n.response.status===400&&c.warning({title:"Warning",message:s})}),N.reset()}const Q=document.querySelectorAll(".footer_soc_item");Q.forEach(t=>{const e=t.querySelector(".footer_soc_icon");t.addEventListener("mouseenter",()=>{u.to(t,{keyframes:{"0%":{rotation:-5},"25%":{rotation:5},"50%":{rotation:-5},"75%":{rotation:5},"100%":{rotation:0}},duration:.5,repeat:1}),u.to(e,{keyframes:{"0%":{x:-3},"25%":{x:3},"50%":{x:-3},"75%":{x:3},"100%":{x:0}},duration:.2,repeat:3})}),t.addEventListener("mouseleave",()=>{u.to(t,{rotation:0,duration:.2}),u.to(e,{x:0,duration:.2})})});const C={root:null,rootMargin:"0px",threshold:0},T=document.querySelector(".footer_logo_icon"),U=document.querySelector(".footer_title_span"),W=new IntersectionObserver(V,C);W.observe(T);function V(t,e){t.forEach(a=>{a.isIntersecting&&(u.to(T,{duration:2,opacity:1,x:0,rotationX:360}),u.to(U,{duration:2,opacity:1}))})}const q=document.querySelector(".scroll-up");let L=document.documentElement.scrollTop;q.addEventListener("click",()=>{document.documentElement.scrollTop=0});window.onscroll=_;window.onload=_;function _(){L=document.documentElement.scrollTop,L>100?q.style.display="flex":q.style.display="none"}export{h as A,G as a,X as b,K as r};
//# sourceMappingURL=main-BfFkNJC9.js.map
