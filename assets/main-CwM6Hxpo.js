import{a as w,i as m,g as d}from"./vendor-CDwpJrNp.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const l=w.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});class h{static async getExercises(e={}){const{page:a=1,limit:n=10}=e;return(await l.get("/exercises",{params:{page:a,limit:n,...e}})).data}static async addRateByExerciseId(e,a){return(await l.patch(`/exercises/${e}/rating`,a)).data}static async getExerciseById(e){return(await l.get(`/exercises/${e}`)).data}static async getFilters(e={}){const{page:a=1,limit:n=12}=e;return(await l.get("/filters",{params:{page:a,limit:n,...e}})).data}static async getQuote(){return(await l.get("/quote")).data}static async addSubscription(e){return(await l.post("/subscription",e)).data}}async function _(){try{const t=new Date().toLocaleDateString(),e=JSON.parse(localStorage.getItem("quoteData"));if(e&&e.date===t)return e.quote;let a=await h.getQuote();const n={date:t,quote:a};return localStorage.setItem("quoteData",JSON.stringify(n)),n.quote}catch{console.log("Error during  getting quote")}}_().then(t=>{document.getElementById("quote_text").innerText=t.quote,document.getElementById("quote_author").innerText=t.author});(()=>{const t=document.querySelector(".js-menu-container"),e=document.querySelector(".js-open-menu"),a=document.querySelector(".js-close-menu"),n=document.querySelectorAll(".menu-link"),s=document.querySelector(".mobile-menu-overlay"),o=()=>{const r=e.getAttribute("aria-expanded")==="true"||!1;e.setAttribute("aria-expanded",!r),t.classList.toggle("is-open")};e.addEventListener("click",o),a.addEventListener("click",o),n.forEach(r=>{r.addEventListener("click",o)}),s.addEventListener("click",o),window.matchMedia("(min-width: 768px)").addEventListener("change",r=>{r.matches&&(t.classList.remove("is-open"),e.setAttribute("aria-expanded",!1))})})();const N=(t,e)=>{const a=t.map(n=>`<li class="item"><a href="#">${n}</a></li>`).join("");e.insertAdjacentHTML("beforeend",a)},H=(t,e)=>{const a=t.map(({filter:n,name:s,imgURL:o})=>`
      ...
      `).join("");e.insertAdjacentHTML("beforeend",a)},Q=(t,e)=>{const a=t.map(({bodyPart:n,burnedCalories:s,gifUrl:o,name:r,rating:v,target:u,time:g,_id:f})=>`
      <li class="card-item">
      ...
      `).join("");e.insertAdjacentHTML("beforeend",a)},T=(t,e)=>{const{bodyPart:a,burnedCalories:n,description:s,equipment:o,gifUrl:r,name:v,popularity:u,rating:g,target:f,time:S,_id:L}=t,q=`
      ...
      <div class="modal-content">
        ...
        <div class="modal-details">
            ...
            <p><strong>Burned Calories:</strong> ${n}/${S} min</p>
        </div>
        <p class="description">${s}</p>
        <ul class="modal-controls" data-id=${L}>
      ...
      `;e.innerHTML=q};let i={};const M=async t=>{try{const e=await h.getExerciseById(t);T(e,i.container),i.modal.classList.toggle("is-hidden")}catch(e){console.log(e)}},A=()=>{i={opener:document.querySelector("[data-modal-open]"),closer:document.querySelector("[data-modal-close]"),modal:document.querySelector("[data-modal]"),container:document.querySelector("[data-modal-content]")},!(!i.opener||!i.closer||!i.modal||!i.container)&&(i.opener.addEventListener("click",t=>{const e=t.target;if(e.nodeName!=="A")return;const a=e.dataset.id;a&&M(a)}),i.closer.addEventListener("click",()=>{i.modal.classList.toggle("is-hidden"),i.container.innerHTML=""}))};window.addEventListener("load",()=>{A()});const I=document.querySelector(".js-footer-form"),p=document.querySelector('input[type="email"]'),c=document.querySelector(".footer_form_btn");c.addEventListener("click",j);function b(t){return/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/.test(t)}c.disabled=!0;p.addEventListener("input",()=>{const t=p.value;b(t)?(c.classList.add("active"),c.disabled=!1):(c.classList.remove("active"),c.disabled=!0)});p.addEventListener("blur",()=>{const t=p.value;b(t)?c.classList.add("active"):m.error({title:"Error",message:"Invalid email address was entered."})});function j(t){t.preventDefault();const e=p.value;if(!b(e)){console.log("tyta"),m.error({title:"Error",message:"Invalid email address was entered."});return}const a={email:e};h.addSubscription(a).then(n=>{const s=n.data.message;m.success({title:"Success",message:s})}).catch(n=>{const s=n.response.data.message;n.response.status===409?m.warning({title:"Warning",message:"Subscription already exists"}):n.response.status===400&&m.warning({title:"Warning",message:s})}),I.reset()}const B=document.querySelectorAll(".footer_soc_item");B.forEach(t=>{const e=t.querySelector(".footer_soc_icon");t.addEventListener("mouseenter",()=>{d.to(t,{keyframes:{"0%":{rotation:-5},"25%":{rotation:5},"50%":{rotation:-5},"75%":{rotation:5},"100%":{rotation:0}},duration:.5,repeat:1}),d.to(e,{keyframes:{"0%":{x:-3},"25%":{x:3},"50%":{x:-3},"75%":{x:3},"100%":{x:0}},duration:.2,repeat:3})}),t.addEventListener("mouseleave",()=>{d.to(t,{rotation:0,duration:.2}),d.to(e,{x:0,duration:.2})})});const O={root:null,rootMargin:"0px",threshold:0},$=document.querySelector(".footer_logo_icon"),z=document.querySelector(".footer_title_span"),P=new IntersectionObserver(k,O);P.observe($);function k(t,e){t.forEach(a=>{a.isIntersecting&&(d.to($,{duration:2,opacity:1,x:0,rotationX:360}),d.to(z,{duration:2,opacity:1}))})}const y=document.querySelector(".scroll-up");let E=document.documentElement.scrollTop;y.addEventListener("click",()=>{document.documentElement.scrollTop=0});window.onscroll=x;window.onload=x;function x(){E=document.documentElement.scrollTop,E>100?y.style.display="flex":y.style.display="none"}export{h as A,H as a,Q as b,N as r};
//# sourceMappingURL=main-CwM6Hxpo.js.map
